...
test("file text search requires every term in the file name or searchable metadata", () => {
  ...
  const metadata = {
    ai_snippet: "[Plan] OpenPeek editor | CodeMirror live editing | Frontmatter filters",
  };

  assert.equal(fileMatchesTextFilter(node, metadata, "openpeek live filters"), true);

...
| Public User Guide Demo | [Runnable companion repository](https://github.com/MangoFuture1210/openglance-example-knowledge-base) | User-facing first-run and main-feature demos |

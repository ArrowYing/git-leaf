...
| Public User Guide Demo | [Runnable companion repository](https://github.com/MangoFuture1210/openpeek-example-knowledge-base) | User-facing first-run and main-feature demos |

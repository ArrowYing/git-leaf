...
- If the local working directory is clean and only behind, OpenGlance safely fast-forwards it. Local
...
- If that update affects the focused Source or Live document, OpenGlance prepares it in the background,
  ...
  OpenGlance remains active. Switching to another app leaves it pending. Continued typing invalidates the

export const WORKBENCH_MESSAGES = Object.freeze({
  en: Object.freeze({
    ...
    "help.sync.1": "Git Leaf checks the remote when the repository opens and every 10 minutes. A clean worktree fast-forwards automatically; Check now remains available. Entering Sync expands every folder leading to an unpublished file.",
  ...
  "zh-CN": Object.freeze({
    ...
    "help.sync.title": "同步",
    "help.sync.1": "Git Leaf 会在打开仓库时及每隔 10 分钟检查远端。工作区干净时自动快进更新，同时保留“立即检查”。每次进入 Sync 都会自动展开所有包含未发布文件的目录链。",

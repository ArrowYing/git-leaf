export const WORKBENCH_MESSAGES = Object.freeze({
  en: Object.freeze({
    ...
    "aria.openPeekUpdates": "OpenPeek updates",
    ...
    "remote.mergePendingEditingTitle": "While OpenPeek is active, it will merge automatically after you leave the current editor.",
    ...
    "repository.remove": "Remove from OpenPeek",
    "repository.removeCurrent": "Close and remove from OpenPeek",
    "toast.repositoryRemoved": "Removed {repository} from OpenPeek. Local files were not deleted.",
    "worktree.defaultName": "Worktree",
    "worktree.linkedName": "Worktree - {name}",
    "worktree.detached": "No branch @ {head}",
    "error.load": "Could not load.",
    "error.localeReload": "Language changed, but OpenPeek could not reload before saving the current edit.",
    "error.openTarget": "Could not open target: {message}",
    "branch.created": "Created protective branch: {branch}",
    "branch.detachedHelp": "This worktree has no branch. OpenPeek will create a protective branch when you first edit.",
    ...
    "toast.toolUpdating": "OpenPeek is updating",
    "toast.toolUpdateFailed": "OpenPeek update failed. Run the command again.",
    ...
    "update.downloaded": "The update is ready and will install after OpenPeek quits.",
    "update.available": "A new version is available and is downloading automatically.",
    "update.current": "OpenPeek is up to date.",
    "update.error": "Could not check for updates.",
    "help.title": "OpenPeek Help",
    "help.fileTypes": "File type support",
    "help.shortcutsNote": "OpenPeek auto-saves Source and Live edits.",
    "agentPrompt.title": "Please resolve this OpenPeek sync failure:",
    ...
    "agentPrompt.goal1": "1. Preserve the OpenPeek user's changes to the files above.",
    ...
    "link.editHelp": "Enter a URL for external links, or a relative path, root path, or OpenPeek document URL for repository documents.",
    ...
    "document.fallbackTitle": "OpenPeek document",
    ...
    "update.newVersion": "OpenPeek update",
    ...
    "help.repositoryFiles.1": "OpenPeek always discovers all tracked files and local files not ignored by .gitignore. The sidebar can show “Content files” or “All repository files”. Content mode always includes Markdown, MDX, HTML, images, and PDFs.",
    ...
    "help.filters.1": "Filters depend on docs/frontmatter-rules.json in the target repository. OpenPeek hides the filter button when that file is absent or has no aggregatable frontmatter fields.",
    ...
    "help.worktrees.1": "OpenPeek hides the worktree selector when a repository has only its primary working directory. With multiple worktrees, the selector appears above the sidebar and shows each branch.",
    ...
    "help.worktrees.3": "“No branch” means the worktree does not have a working branch yet. OpenPeek creates a protective branch before the first write so changes never remain on detached HEAD.",
    ...
    "help.sync.1": "OpenPeek checks the remote when the repository opens and at the interval selected under Settings → General (10 minutes by default). A clean worktree fast-forwards automatically; Check now remains available. Entering Sync expands every folder leading to an unpublished file.",
    "help.sync.2": "When remote updates and unpublished local edits can be combined safely, OpenPeek merges them automatically and leaves every local edit uncommitted. An update affecting the focused Source or Live document stays pending until focus leaves the editor, so continued typing is never discarded. Merge remote changes remains available while it waits or when the protected merge needs a retry. Sync and publish is the separate manual action that commits and pushes all repository changes.",
    "help.sync.3": "OpenPeek does not rewrite diverged history or put an unresolved merge into the real workspace. Conflicts and unexpected Git states stop safely; use the displayed AI Agent prompt only as the fallback.",
    ...
    "help.sharing.3": "When a recipient opens the link, OpenPeek checks the local primary workspace and shared revision. It asks before switching from another worktree, preserving local changes while updating main, or syncing overlapping files.",
    ...
    "help.telemetry.1": "Official OpenPeek builds may send an anonymous installation identifier, app version, update status, daily active duration and foreground exposure, repository count, and aggregate core-feature counts to understand installation health and real usage.",
  ...
  "zh-CN": Object.freeze({
    ...
    "aria.openPeekUpdates": "OpenPeek 更新",
    ...
    "remote.mergePendingEditingTitle": "OpenPeek 处于前台时，离开当前编辑区域后会自动完成合并。",
    ...
    "repository.remove": "从 OpenPeek 移除",
    "repository.removeCurrent": "关闭并从 OpenPeek 移除",
    "toast.repositoryRemoved": "已从 OpenPeek 移除 {repository}，本地文件未被删除。",
    "worktree.defaultName": "工作树",
    "worktree.linkedName": "工作树 - {name}",
    "worktree.detached": "无分支 @ {head}",
    "error.load": "加载失败。",
    "error.localeReload": "语言已更改，但 OpenPeek 无法在保存当前编辑后重新加载。",
    ...
    "toast.toolUpdating": "OpenPeek 正在更新",
    "toast.toolUpdateFailed": "OpenPeek 更新失败，请重新运行命令",
    ...
    "newFolder.inDirectory": "将在“{name}”中创建。OpenPeek 会加入 .gitkeep，让空文件夹也能进入 Git。",
    "newFolder.repoHome": "将在仓库首页创建。OpenPeek 会加入 .gitkeep，让空文件夹也能进入 Git。",
    ...
    "update.downloaded": "新版本已准备好，退出 OpenPeek 后自动安装。",
    "update.available": "发现新版本，正在自动下载。",
    "update.current": "OpenPeek 已经是最新版本。",
    "update.error": "检查更新失败。",
    "help.title": "OpenPeek 帮助",
    "help.fileTypes": "文件类型支持",
    "help.shortcutsNote": "OpenPeek 会自动保存 Source 和 Live 编辑内容。",
    "agentPrompt.title": "请处理 OpenPeek 同步失败：",
    ...
    "agentPrompt.goal": "目标：",
    "agentPrompt.goal1": "1. 保留 OpenPeek 用户对上述文件的修改。",
    ...
    "link.editTitle": "修改链接",
    "link.editHelp": "外部链接填 URL；仓库内文档填相对路径、根路径或 OpenPeek 文档 URL。",
    ...
    "image.updated": "已更新图片",
    "document.fallbackTitle": "OpenPeek 文档",
    ...
    "update.newVersion": "OpenPeek 新版本",
    ...
    "help.repositoryFiles.1": "OpenPeek 始终发现仓库中全部已跟踪文件和未被 .gitignore 忽略的本地文件。目录树可以选择“内容文件”或“全部仓库文件”。内容文件模式默认显示 Markdown / MDX、HTML、图片和 PDF；HTML 常用于原型、副文本输出和报表，因此与 PDF 一样作为内容常驻展示。",
    ...
    "help.filters.1": "筛选按钮依赖目标仓库里的 docs/frontmatter-rules.json。没有这个规则文件，或规则里没有可用于聚合的 frontmatter 字段时，OpenPeek 会隐藏筛选按钮。",
    ...
    "help.worktrees.1": "仓库只有一个主工作目录时，OpenPeek 不显示工作树选择器。检测到多个 worktree 后，左侧目录树上方会显示选择器，并标出各工作目录所在分支。",
    "help.worktrees.2": "正常分支都可以使用 Preview、Source 和 Live。切换 worktree 时，OpenPeek 会分别恢复该工作目录的 Tab、目录展开、滚动和焦点状态。",
    "help.worktrees.3": "显示“无分支”表示当前 worktree 还没有工作分支。第一次实际写入前，OpenPeek 会自动创建保护分支，避免修改停留在 Detached HEAD。",
    "help.worktrees.4": "普通同事通常不需要主动创建或切换 worktree；不确定当前工作目录用途时，先保持主工作目录，或交给 AI Agent 确认。",
    "help.sync.title": "同步",
    "help.sync.1": "OpenPeek 会在打开仓库时检查远端，之后按“设置 → 常规”中的频率继续检查（默认每隔 10 分钟）。工作区干净时自动快进更新，同时保留“立即检查”。每次进入 Sync 都会自动展开所有包含未发布文件的目录链。",
    "help.sync.2": "远端更新与本地未发布编辑能够安全合并时，OpenPeek 会自动完成合并，全部本地编辑仍保持未提交。更新涉及当前聚焦的 Source 或 Live 文档时，会先保持待合并，离开编辑区域后再自动应用，因此继续输入不会被丢弃；等待期间或受保护合并需要重试时，都可以使用“合并远端修改”。“同步并发布”仍是另一个人工操作，才会提交并推送整个仓库的改动。",
    "help.sync.3": "OpenPeek 不会改写已经分叉的历史，也不会把未解决冲突留在真实工作区。遇到冲突或异常 Git 状态时会安全停止，只有万不得已才使用界面提供的 AI Agent 提示词。",
    ...
    "help.sharing.3": "接收方点击链接后，OpenPeek 会检查本地主工作区和分享版本。需要从其他 worktree 切回主工作区、保留本地修改更新 main，或先同步重叠文件时，应用会先明确询问。",
    "help.sharing.4": "分享发布失败时，本地修改和已经创建的提交都会保留；检查网络、GitHub 登录或远端分支状态后可以原地重试，也可以把失败提示交给 AI Agent。分享链接不会授予 GitHub 权限；接收方本机尚未打开对应仓库时，OpenPeek 会要求选择本机目录并核对 GitHub origin。",
    "help.telemetry.title": "基础使用统计",
    "help.telemetry.1": "OpenPeek 正式版会发送匿名安装实例、App 版本、更新状态、每日活跃时长与前台展示时长、仓库数量和核心功能次数，用于了解安装更新是否正常以及工具是否被实际使用。",

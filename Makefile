...
OPENGLANCE_RELEASE_PROFILE ?= $(if $(OPENPEEK_RELEASE_PROFILE),$(OPENPEEK_RELEASE_PROFILE),$(GIT_LEAF_RELEASE_PROFILE))
RELEASE_DMG := dist/OpenGlance-$(VERSION)-darwin-universal.dmg

release-env = OPENGLANCE_RELEASE_PROFILE="$(OPENGLANCE_RELEASE_PROFILE)" OPENPEEK_RELEASE_PROFILE="$(OPENGLANCE_RELEASE_PROFILE)" GIT_LEAF_RELEASE_PROFILE="$(OPENGLANCE_RELEASE_PROFILE)" VERSION="$(VERSION)"
win-release-env = OPENGLANCE_RELEASE_PROFILE="$(OPENGLANCE_RELEASE_PROFILE)" OPENPEEK_RELEASE_PROFILE="$(OPENGLANCE_RELEASE_PROFILE)" GIT_LEAF_RELEASE_PROFILE="$(OPENGLANCE_RELEASE_PROFILE)" VERSION="$(VERSION)"

(() => {
  ...
  const api = window.openPeekSettings;
  const messages = Object.freeze({
    en: Object.freeze({
      documentTitle: "OpenPeek Settings & Help",
      backAria: "Back to OpenPeek",
      back: "Back",
      ...
      generalDescription: "Common preferences for OpenPeek.",
      appearanceKicker: "Appearance",
      appearanceTitle: "Appearance",
      appearanceDescription: "Personal preferences that shape your reading experience.",
      languageTitle: "Interface language",
      languageDescription: "Follow your system language or choose a language for OpenPeek.",
      languageAria: "Interface language",
      languageAuto: "Auto",
      languageSystem: "Follow system",
      colorModeTitle: "Color mode",
      colorModeDescription: "When following the system, OpenPeek switches with macOS or Windows.",
      ...
      gitRemoteCheckDescription: "Choose how often OpenPeek fetches and checks the Git remote.",
      ...
      shortcutsDescription: "System menu commands and current OpenPeek keyboard actions.",
      ...
      desktopOnly: "The settings center is available only in the OpenPeek desktop app.",
      readSettingsFailed: "Unable to read OpenPeek settings.",
      ...
      updateCurrent: "OpenPeek is up to date.",
    ...
    "zh-CN": Object.freeze({
      documentTitle: "OpenPeek 设置与帮助",
      backAria: "返回 OpenPeek",
      back: "返回",
      sidebarAria: "设置与帮助栏目",
      ...
      generalKicker: "设置",
      generalTitle: "常规",
      generalDescription: "OpenPeek 的常用设置。",
      appearanceKicker: "外观",
      appearanceTitle: "外观",
      appearanceDescription: "只保留会持续影响阅读体验的个人偏好。",
      languageTitle: "界面语言",
      languageDescription: "跟随系统语言，或为 OpenPeek 选择固定语言。",
      languageAria: "界面语言",
      languageAuto: "自动",
      languageSystem: "跟随系统",
      colorModeTitle: "明暗模式",
      colorModeDescription: "跟随系统时，OpenPeek 会随 macOS 或 Windows 的外观自动切换。",
      colorModeAria: "明暗模式",
      ...
      gitRemoteCheckDescription: "设置 OpenPeek 获取并检查 Git 远端变化的频率。",
      ...
      shortcutsKicker: "键盘",
      shortcutsTitle: "快捷键",
      shortcutsDescription: "保留系统菜单入口和 OpenPeek 当前键盘操作。",
      statusKicker: "关于与状态",
      statusTitle: "关于与状态",
      statusDescription: "查看版本、运行环境以及当前仓库状态。",
      updateActionsAria: "更新操作",
      checkForUpdates: "检查更新",
      desktopOnly: "设置中心只能在 OpenPeek 桌面版中使用。",
      readSettingsFailed: "无法读取 OpenPeek 设置。",
      ...
      updateCurrent: "OpenPeek 已经是最新版本。",

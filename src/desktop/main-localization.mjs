...
const MAIN_MESSAGES = Object.freeze({
  en: Object.freeze({
    ...
    "share.mainMissing":
      "OpenGlance could not find an available main worktree for this repository. Make sure the main worktree still exists on this computer, then open the link again.",
    ...
    "share.repositoryNotAdded": "This repository has not been added to OpenGlance",
    ...
    "share.fetchFailedDetail":
      "OpenGlance could not fetch the latest main from GitHub. Check the network and GitHub access, then open the link again.",
    ...
    "share.aheadDetail":
      "The local main worktree has unpushed commits. Finish Git sync in OpenGlance, then open the link again.",
    ...
    "share.repositoryUnknown":
      "{repository} is not yet in OpenGlance’s repository list.\nChoose its local folder so OpenGlance can verify the GitHub origin and continue opening this link.",
    "share.worktreeUnknown":
      "OpenGlance has not found worktree {worktree} for {repository} on this computer.\nChoose any local worktree of the repository and OpenGlance will continue looking for the linked worktree.\nIf that worktree only exists on another computer, open the link on the computer where it was created.",
    "share.repositorySelectionMismatch":
      "This link requires {repository}.\nChoose a local folder for that GitHub repository; OpenGlance will not substitute another repository.",

    "windows.updateFailedTitle": "OpenGlance update failed",
    "windows.updateFailedStage": "Update failed",
    "windows.updateFailed": "OpenGlance could not update.",
    ...
    "windows.installIncomplete": "OpenGlance installation did not complete. Extract the full package and try again.",
    "windows.noPreviousInstall": "This is the first installation, so there is no previous version to restore.",
    "windows.restoredStartMenu": "The previous version was restored. Start OpenGlance again from the Start menu; you can retry the update later.",
    "windows.restoredPortable": "The previous version was restored. Double-click OpenGlance.exe in this newly extracted folder again.",
    "windows.previousAvailable": "The previous version in the fixed installation folder is still available.",
    "windows.quitRunningTitle": "Quit the running OpenGlance first",
    "windows.quitRunningDetail":
      "Another OpenGlance process is still running, so no installation files were changed.\n\nQuit the old version, then double-click OpenGlance.exe in this newly extracted folder again.",
    "windows.prepareFailedTitle": "Could not prepare OpenGlance",
    "windows.prepareFailedDetail":
      "OpenGlance could not update its fixed installation folder.\n\nQuit the running OpenGlance, then double-click this new version again.",
    "windows.startMenuShortcutDescription":
      "Open Git repositories and Markdown documents in OpenGlance.",

    "startup.configInvalidTitle": "OpenGlance settings are damaged",
    "startup.failedTitle": "OpenGlance could not start",
    "startup.configInvalidDetail":
      "OpenGlance could not read either the settings file or its backup.\n\nTo avoid overwriting repositories, appearance settings, or workspace state, the app stopped and left the existing files unchanged.",
  }),
  "zh-CN": Object.freeze({
    ...
    "share.mainMissing":
      "OpenGlance 找不到这个仓库可用的主工作区。请确认主工作区仍在本机且可以访问，再重新打开链接。",
    ...
    "share.repositoryNotAdded": "此仓库尚未添加到 OpenGlance",
    ...
    "share.fetchFailedDetail":
      "OpenGlance 无法从 GitHub 获取最新 main。请检查网络和 GitHub 访问状态，然后重新打开链接。",
    "share.technicalDetail": "技术信息：{detail}",
    "share.revisionMissingDetail": "origin/main 已不再包含链接中的文档版本。请联系分享者重新生成链接。",
    "share.aheadDetail": "本地主工作区有尚未推送的 commit。请先在 OpenGlance 中完成 Git 同步，再重新打开链接。",
    ...
    "share.repositoryUnknown":
      "OpenGlance 的仓库列表里还没有 {repository}。\n选择它的本机目录后，OpenGlance 会核对 GitHub origin，并继续打开当前链接。",
    "share.worktreeUnknown":
      "OpenGlance 在本机尚未找到 {repository} 的目标工作树 {worktree}。\n请选择该仓库任一工作树的本机目录，OpenGlance 会继续查找链接指定的工作树。\n如果目标工作树只存在于另一台电脑，请在创建链接的电脑上打开。",
    "share.repositorySelectionMismatch":
      "这个链接需要 {repository}。\n请选择该 GitHub 仓库的本机目录；OpenGlance 不会用其他仓库替代打开。",

    "windows.updateFailedTitle": "OpenGlance 更新失败",
    "windows.updateFailedStage": "更新失败",
    "windows.updateFailed": "OpenGlance 更新失败",
    "windows.switchFailed": "新版本切换失败，并且没有自动恢复到固定目录。",
    "windows.backupPreserved": "旧版本备份仍保留在：{path}",
    "windows.installIncomplete": "OpenGlance 安装未完成。请重新完整解压安装包后再试。",
    "windows.noPreviousInstall": "这是首次安装，固定目录中没有可恢复的旧版本。",
    "windows.restoredStartMenu": "原版本已恢复。请从开始菜单重新启动 OpenGlance，稍后可以再次更新。",
    "windows.restoredPortable": "原版本已恢复。请重新双击这个新版解压目录中的 OpenGlance.exe。",
    "windows.previousAvailable": "固定目录中的原版本仍然可用。",
    "windows.quitRunningTitle": "请先完全退出正在运行的 OpenGlance",
    "windows.quitRunningDetail":
      "检测到另一个 OpenGlance 仍在运行，因此尚未修改任何安装文件。\n\n请退出旧版本，然后重新双击这个新版解压目录中的 OpenGlance.exe。",
    "windows.prepareFailedTitle": "无法准备 OpenGlance",
    "windows.prepareFailedDetail":
      "OpenGlance 无法更新本机固定安装位置。\n\n请先退出正在运行的 OpenGlance，然后重新双击这个新版本。",
    "windows.startMenuShortcutDescription":
      "在 OpenGlance 中打开 Git 仓库和 Markdown 文档。",

    "startup.configInvalidTitle": "OpenGlance 配置文件损坏",
    "startup.failedTitle": "OpenGlance 启动失败",
    "startup.configInvalidDetail":
      "OpenGlance 检测到设置文件和备份都无法读取。\n\n为避免覆盖原有仓库、外观与工作台状态，App 已停止启动，现有文件保持不变。",
  }),
});

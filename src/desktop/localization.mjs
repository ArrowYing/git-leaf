...
export const DESKTOP_MESSAGES = Object.freeze({
  en: Object.freeze({
    ...
    "menu.removeRepository": "Remove Repository from OpenPeek",
    "menu.edit": "Edit",
    "menu.undo": "Undo",
    "menu.redo": "Redo",
    "menu.cut": "Cut",
    ...
    "menu.help": "Help",
    "menu.openPeekHelp": "OpenPeek Help...",

    "home.subtitle": "Git-based docs workbench",
    "home.introduction":
      "Choose a local Git repository to open its Markdown / MDX documentation workspace in OpenPeek.",
    ...
    "home.blockedMessage":
      "OpenPeek needs access to the Git command before it can open a local repository.",
    "home.blockedAction":
      "Set up Git, then reopen OpenPeek or return to this page and try again.",
    ...
    "settings.analyticsOn":
      "Usage analytics are on. OpenPeek sends only anonymous summaries and update state; it never sends repository names, paths, file names, search terms, document content, or Git identity.",
    ...
    "updates.downloaded": "The new version is ready and will install after OpenPeek quits.",
    "updates.available": "A new version is available and is downloading automatically.",
    "updates.current": "OpenPeek is up to date.",
    ...
    "updates.availableVersion":
      "OpenPeek {version} is available and is downloading automatically.",
    "updates.handoffAvailableVersion":
      "The internal OpenPeek {version} release is available and is downloading automatically.",
    "updates.disabledDevBuild":
      "Only a packaged OpenPeek dev installation can switch to the internal release.",
    "updates.disabledSourceBuild":
      "Community Builds do not connect to the official OpenPeek update service. Install a signed official build to receive updates.",
  ...
  "zh-CN": Object.freeze({
    ...
    "menu.removeRepository": "从 OpenPeek 移除仓库",
    "menu.edit": "编辑",
    "menu.undo": "撤销",
    "menu.redo": "重做",
    "menu.cut": "剪切",
    ...
    "menu.zoomOut": "缩小",
    "menu.help": "帮助",
    "menu.openPeekHelp": "OpenPeek 帮助…",

    "home.subtitle": "Git 文档工作台",
    "home.introduction":
      "选择一个本地 Git 仓库后，OpenPeek 会在桌面窗口中打开 Markdown / MDX 文档工作台。",
    "home.readyTitle": "环境已就绪",
    "home.readyMessage": "可以打开本地 Git 仓库。",
    "home.blockedTitle": "环境未就绪",
    "home.blockedMessage": "OpenPeek 需要先检测到 Git 命令，才能打开本地仓库。",
    "home.blockedAction": "请先处理 Git 命令，然后重新打开 OpenPeek 或回到此页面再试。",
    ...
    "updates.downloaded": "新版本已准备好，退出 OpenPeek 后自动安装。",
    "updates.available": "发现新版本，正在自动下载。",
    "updates.current": "OpenPeek 已经是最新版本。",
    "updates.error": "检查更新失败。",
    "updates.packageUnavailable": "更新包暂不可用，点击重试。",
    "updates.availableVersion": "OpenPeek {version} 可用，正在自动下载。",
    "updates.handoffAvailableVersion":
      "OpenPeek {version} 内部正式版可用，正在自动下载。",
    "updates.disabledDevBuild":
      "只有已打包安装的 OpenPeek dev 才能切换到内部正式版。",
    "updates.disabledSourceBuild":
      "社区构建不会连接 OpenPeek 官方更新服务。请从官方渠道安装签名版本以接收更新。",
    ...
    "updates.unsupportedPlatform": "当前平台暂不支持 OpenPeek 自动更新。",

...
const GIT_SHARE_PUBLISH_MESSAGES = Object.freeze({
  en: Object.freeze({
    ...
    "prompt.title": "Please resolve this Git Leaf share publication failure:",
    ...
    "prompt.goal": "Goal:",
    "prompt.goalPreserve": "1. Preserve the Git Leaf user's changes to the files above.",
  ...
  "zh-CN": Object.freeze({
    ...
    "prompt.title": "请处理 Git Leaf 分享链接发布失败：",
    ...
    "prompt.goal": "目标：",
    "prompt.goalPreserve": "1. 保留 Git Leaf 用户对上述文件的修改。",

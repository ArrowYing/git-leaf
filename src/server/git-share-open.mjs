...
const SHARED_FETCH_FAILURE_MESSAGES = Object.freeze({
  en: Object.freeze({
    ...
    "network_unavailable.summary": "OpenPeek retried automatically but still could not fetch the latest main.",
    ...
    "authentication_required.summary": "OpenPeek could not access the remote with this repository's current Git credentials.",
    ...
    "unavailable.summary": "OpenPeek could not find the Git command and cannot fetch the latest main.",
    ...
    "permission_denied.summary": "OpenPeek does not have permission to run Git or read the main worktree.",
    ...
    "invalid_context.summary": "OpenPeek could not fetch the latest main from the original main worktree.",
    ...
    "interrupted.summary": "OpenPeek retried automatically, but the Git operation was interrupted again before it finished.",
    ...
    "failed.summary": "OpenPeek encountered a problem while fetching the remote main.",

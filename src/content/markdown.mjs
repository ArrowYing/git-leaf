...
const MARKDOWN_MESSAGES = Object.freeze({
  en: Object.freeze({
    ...
    "mermaid.focusNode": "Focus node",
    "mermaid.allNodes": "All nodes",
    "mermaid.nodes": "nodes",
    "mermaid.relations": "relations",
  ...
  "zh-CN": Object.freeze({
    ...
    "mermaid.focusNode": "聚焦节点",
    "mermaid.allNodes": "全部节点",
    "mermaid.nodes": "个节点",
    "mermaid.relations": "条关系",
    "mermaid.fit": "适应宽度",
    "mermaid.zoomOut": "缩小",
    "mermaid.zoomIn": "放大",
...
function renderMermaidShell(source, translate) {
  ...
  return [
    ...
    '<label class="mermaid-diagram-focus" data-mermaid-focus-control hidden>',
    `<span class="visually-hidden">${escapeHtml(t("mermaid.focusNode"))}</span>`,
    `<select data-mermaid-focus aria-label="${escapeAttribute(t("mermaid.focusNode"))}" data-mermaid-all-nodes-label="${escapeAttribute(t("mermaid.allNodes"))}">`,
    `<option value="">${escapeHtml(t("mermaid.allNodes"))}</option>`,
    "</select></label>",
    `<span class="mermaid-diagram-focus-summary" data-mermaid-focus-summary data-mermaid-nodes-label="${escapeAttribute(t("mermaid.nodes"))}" data-mermaid-relations-label="${escapeAttribute(t("mermaid.relations"))}" hidden></span>`,
